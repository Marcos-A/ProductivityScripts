...
""" recursiveSpaceToUnderscoreReplacer 1.0
Script to replace spaces with underscores in file and dir names recursively.
"""
...
def replace_spaces_with_underscores(current_dir):
    ...
    for entry in dirs_and_files:
        ...
        if entry.is_dir() is True:
            replace_spaces_with_underscores(os.path.join(current_dir, result_name))
